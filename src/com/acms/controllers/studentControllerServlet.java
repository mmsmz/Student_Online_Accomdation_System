...
public class studentControllerServlet extends HttpServlet {
	...
	private void updateStudent(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		String fathercontactno = request.getParameter("fathercontactno");
		String mothername = request.getParameter("mothername");
		String mothercontactno = request.getParameter("mothercontactno");
		String schoolattended = request.getParameter("schoolattended");
		String emergencyno = request.getParameter("emergencyno");
		String medium = request.getParameter("medium");
		String mediclecondition = request.getParameter("mediclecondition");
		boolean isDeleted = Boolean.parseBoolean(request.getParameter("isDeleted"));
		// create a new student object
		Student theStudent = new Student(student_id, firstName, lastName, address, email, telephone, dob, gender, nationality, fathername, fathercontactno, mothername, mothercontactno, schoolattended, emergencyno, medium, mediclecondition, isDeleted);
